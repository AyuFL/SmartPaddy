...
class RegisterActivity : AppCompatActivity() {
  ...
  private fun playAnimation() {
    val title = ObjectAnimator.ofFloat(binding.tvRegisterTitle, View.ALPHA, 1f).setDuration(300)
    val nameTitle = ObjectAnimator.ofFloat(binding.tvName, View.ALPHA, 1f).setDuration(300)
    val name = ObjectAnimator.ofFloat(binding.etName, View.ALPHA, 1f).setDuration(300)
    val emailTitle = ObjectAnimator.ofFloat(binding.tvEmail, View.ALPHA, 1f).setDuration(300)
    val email = ObjectAnimator.ofFloat(binding.etEmail, View.ALPHA, 1f).setDuration(300)
    val passwordTitle =
    ...
    val loginButton = ObjectAnimator.ofFloat(binding.tvLogin, View.ALPHA, 1f).setDuration(300)
    val showPassword = ObjectAnimator.ofFloat(binding.cbShowPassword, View.ALPHA, 1f).setDuration(300)

    AnimatorSet().apply {
      playSequentially(title, nameTitle, name, emailTitle, email, passwordTitle, password, showPassword, registerButton, loginButton)
      start()
    }
  }
